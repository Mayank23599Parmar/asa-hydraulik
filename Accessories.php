...
<head>
    <meta charset="utf-8">
    <title>Accessories | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Accessories</h1>
                    <h5>Limit Switch for butterfly flanges and suction units</h5>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-12 ptop_0 pt-3">
                <p>Optional to the asasuction units and butterfly flanges we offer mechanical and inductive limit
                    switches. The limit switch can be mounted on the standard block for monitoring matters. The
                    lever position corresponds to the valve position. Thus the aperture angle is well-defined even
                    in mounted state. The handle direction (clockwise or counter clockwise) can be changed by
                    turning the switch bracket. Please note that the butterfly flange may only be opened in mounted
                    state and with greased or lubricated sealing.
                </p>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto pt-3">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        ...
                        <div>
                            <img src="assets/img/connection-techonology/Accessories1.jpg" style="width: 60%; padding-bottom: 10px;">
                        </div>
                        <div class="download_catelog">
                            <a href="assets/pdf/limit-switch.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>

            <div class="col-md-6 mtop_25">
                <h5>Mechanical Limit Switch</h5>
                <br>
                <img src="assets/img/connection-techonology/Accessories3-5.jpg" alt="">
            </div>
            <div class="col-md-6">
                <h5>Inductive Limit Switch</h5>
                <br>
                <img src="assets/img/connection-techonology/Accessories2-4.png" alt="">
            </div>
        </div>
    </div>
</section>

<section class="mtop_25">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Accessories</h1>
                    <h5>Adapter Flange DN 40 DN 125</h5>
                </div>
            </div>

            <div class="col-lg-9 col-md-12 pt-3">
                <p>The asasuction unit is screwed to the asaadapter flange, which is welded to the tank. Due to low
                    installation costs and compact design, purchasing asa suction units is cost effective. A switch
                    (mechanical or inductive) can be mounted on the standard block for monitoring matters. The
                    adapter flange may only be welded with demounted butterfly flange.
                </p>
                <img src="assets/img/connection-techonology/Accessories6.jpg" alt="" class="full_width">
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        ...
                        <div>
                            <img src="assets/img/connection-techonology/Accessories7.jpg" style="padding-bottom: 10px;">
                        </div>
                        <div class="download_catelog">
                            <a href="assets/pdf/adapter-flange.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Accessories</h1>
                    <h5>Suction strainer adapter</h5>
                </div>
            </div>

            <div class="col-lg-9 col-md-12 pt-3">
                <p>Request more information on this new type of adapter that combines the welding flange for the
                    butterfly valve with a thread port to the suction strainer.
                </p>

                <div class="col-md-10 offset-1">
                    <img src="assets/img/connection-techonology/Accessories8.png" alt="" class="full_width">
                </div>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        <h5>New strainer adapter
                        </h5>

                        <div>
                            <img src="assets/SDAK0080T-exp-China.jpg" style="padding-bottom: 10px;">
                        </div>
                        <div class="download_catelog">
                            <a href="contact.php">Send a request</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="mtop_25">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 pt-3">
                <p>Our new lockable pin is an optional pin to protect unforeseen or not qualified operation of the hand
                    lever of the butterfly valve. This locking pin is available on request on each size of our butterfly
                    valves.
                </p>

                <div class="col-md-6 offset-3">
                    <img src="assets/img/connection-techonology/Accessories9.png" alt="" class="full_width">
                </div>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-12">
                <div id="property-single-carousel" class="owl-carousel owl-arrow gallery-property">
                    ...
                    <div class="carousel-item-b">
                        <img src="assets/img/connection-techonology/Accessories4.jpg" alt="">
                    </div>
                    <div class="carousel-item-b">
                        <img src="assets/img/connection-techonology/Accessories2.jpg" alt="">
                    </div>
                    <div class="carousel-item-b">
                        <img src="assets/img/connection-techonology/Accessories1.jpg" alt="">
                    </div>
                    <div class="carousel-item-b">
                        <img src="assets/img/connection-techonology/Accessories.jpg" alt="">
                    </div>
                </div>
            </div>
