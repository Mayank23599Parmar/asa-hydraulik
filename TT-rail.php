            ...
            <div class="col-md-12">
                <div class="display-flex">
                    <div class="col-lg-9 col-md-12 ptb-30">
                        ...
                        <p>Maximum oil temperature: 100°C, maximum air temperature: 50°C. Motors can be used up to an altitude of 1.500m. For other conditions of use please contact our engineers.</p>
                        <h6>Noise level: </h6>
                        <p>Noise levels are measured in accordance with 2006/42/EC and EN ISO 3744.</p>
                        <h6>Dimensions: </h6>
                        <p>General tolerance according to DIN 2768-v</p><br>
                        <h5>Connection</h5>
                        <p>The asa rail system is the first worldwide flexible mounting and connection system for air blast heat
                            exchangers. It gives you the free choice of the connector direction through turnable ports. The rail
                            slots in the radiator are the frame structure not only for connecting the ports, also for various
                            possible mounting arrangements such as bypass systems, mounting of the cooler to aggregates,
                            measurement devices and much more. Please contact us to discover the huge potential of this system
                            for your application.</p>
                        <br>
                        <!--<h5>Scale Drawing</h5>
                        <img src="assets/img/special-ranges/cc-series.jpg" alt="">-->
                        <div class="ptb-30"><h5>Performance</h5>
                            <img src="assets/img/special-ranges/cc-series3.jpg" alt=""></div>
                    </div>
                    <div class="col-lg-3 col-md-5 margin_auto">
                        <div class="feature-imagebox border download-action">
                            <div class="block">
                                ...
                                <div>
                                    <img src="assets/img/special-ranges/cc-series1.jpg" alt="" style="padding-bottom: 10px;">
                                </div>
                                <div class="download_catelog">
                                    <a href="assets/pdf/tt-rail.pdf" target="_blank">Download Catalogue<i class="fa fa-file-pdf-o"></i></a>
                                </div>
                            </div>
                        </div>
                        <!--<div>
                            <img src="assets/img/special-ranges/cc-series1.jpg" alt="" class="full_width">
                        </div>-->
                        <br>
                        <div>
