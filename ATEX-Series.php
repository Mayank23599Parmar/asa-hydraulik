...
<head>
    <meta charset="utf-8">
    <title>ATEX-Series | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Explosion-proof oil/air coolers / ATEX-Series</h1>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="display-flex">
                    <div class="col-lg-9 col-md-12 ptb-30">
                        <p>asa oil/air coolers are available for ATEX zone 1, 2 and 22, which corresponds to the
                            categories 2G and 3. Download the information brochure and learn more about the possible
                            ATEX applications from the mentioned table.</p>

                        <p>The shown cooler models are available with AC drive, but also with hydraulic motor fan drive.
                            Our ATEX coolers are equipped either with our well established asa universal connectors or
                            the asa rail system for the hydraulic connection.</p><br>
                        <img src="assets/img/atex-series/ATEX-series1.jpg" alt="" class="full_width">
                    </div>
                    <div class="col-lg-3 col-md-5 margin_auto">
                        <div class="feature-imagebox border download-action">
                            <div class="block">
                                ...
                                <p>Download information brochure or request more information.</p>

                                <div>
                                    <img src="assets/img/atex-series/ATEX-series.gif" alt="" style="padding-bottom: 10px;">
                                </div>
                                <div class="download_catelog">
                                    <a href="assets/pdf/atex-series.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
