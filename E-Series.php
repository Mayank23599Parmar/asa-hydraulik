...
<head>
    <meta charset="utf-8">
    <title>E–Series | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Plate heat exchangers /
                        E-series</h1>
                    <h5>Brazed Plate Heat Exchangers</h5>
                </div>
            </div>
          ...
          <div class="col-md-12">
              <div class="display-flex">
                  <div class="col-lg-9 col-md-12 ptb-30">
                      <h6>Construction</h6>

                      <p>The Plate Heat Exchangers ASA-PL is designed for hydraulic fluid and lubricating.The benefits of
                          plate hate exchangers are:</p>
                      <ul>
                          <li>strength</li>
                          <li>installation dimension</li>
                          <li>low maintenance</li>
                          <li>efficiency</li>
                      </ul>
                      <h6>Design</h6>

                      <p>The structure of the ASA-PL cooling surfaces, i. thin, profiled plates made of acid-proof stainless
                          steel (1.4306) is compact and powerful. The plates are profiled on the one hand to achieve optimum
                          heat transfer and on the other hand to form channels in which oil or water is guided. The plate pack
                          has a cover plate on each side. The entire heat exchanger is soldered together at the outer edges
                          and at the inner points of contact. The cooler can be installed in a feed pump circuit and in return
                          lines with large pressure variations. This product is also suitable for water, air and gas.</p>
                  </div>
                  <div class="col-lg-3 col-md-5 margin_auto">
                      <img src="assets/img/e-series/e-series.jpg" alt="">
                  </div>
              </div>
          </div>
            <div class="col-md-12">
                ...
                <p>Our standard range of plate heat exchanger covers a large field of applications to ensure you
                    competitive pricing, high quality and short delivery times. Contact us for more information and non
                    standard coolers to work out the optimal solution for you.</p>
            </div>
            <div class="col-md-12">
                <h6>Technical Data</h6>
                <div class="row">
                    <div class="col-lg-9 col-md-12">
                        <img src="assets/img/e-series/e-series1.jpg" alt="">
                    </div>
                    <div class="col-lg-3 col-md-5 margin_auto">
                        <div class="feature-imagebox border download-action">
                            <div class="block">
                                <h5>E–Series</h5>
                                <div>
                                    <img src="assets/img/e-series/e-series7.jpg" alt="" style="padding-bottom: 10px;">
                                </div>
                                <div class="download_catelog">
                                    <a href="assets/pdf/e-series.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <p>he shown performance curves created at an oil / water ratio of 2:1 with hydraulic oil ISO VG 32 at an
                    oil inlet temperature of 60°C and a water entrance of 20°C. Please contact us for other technical
                    parameters to select the optimal cooler for you.</p>
            </div>
            <div class="col-md-6">
                <p>colling performance</p>
                <img src="assets/img/e-series/13.1.PNG" alt="">
                <img src="assets/img/e-series/13.3.PNG" alt="">
               <!-- <img src="assets/img/e-series/e-series4.jpg" alt="">-->
            </div>
            <div class="col-md-6">
                <p>pressure drops (oil side)</p>
                <img src="assets/img/e-series/13.2.PNG" alt="">
                <img src="assets/img/e-series/13.4.PNG" alt="">
               <!-- <img src="assets/img/e-series/e-series2.jpg" alt="">-->
            </div>
            <div class="col-md-12 ptb-30">
                <div class="col-md-12">
                    <h5>Mounting brackets </h5>
                    <div class="row">
                        <div class="col-md-6">
                            <img src="assets/img/e-series/e-series7.jpg" alt="">
                        </div>
                        <div class="col-md-6">
                            <img src="assets/img/e-series/e-series8.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row">
                    <div id="property-single-carousel" class="owl-carousel owl-arrow gallery-property">
                        ...
                        <div class="carousel-item-b">
                            <img src="assets/img/e-series/e-series6.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
