...
<head>
    <meta charset="utf-8">
    <title>MAC Series | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Oil/Air Cooler MAC</h1>
                    <h5>12V / 24V DC, HP (high performance) up to 300l/min</h5>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <p>The new MAC series unites the most important requirements of a mobile cooling system in a very
                    cost efficient way with sufficient and proven quality. We offer 5 different radiator sizes with
                    various fan motor options. Gain from our nearly 40 years of experience for mobile hydraulics and
            ...
            <!--<div class="col-lg-9 col-md-12">
                <img src="assets/img/standard-ranges/MAC-Series3.JPG" alt="">
            </div>-->
            <div class="col-lg-9 col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        <img src="assets/img/standard-ranges/MAC-Series4.jpg">
                    </div>
                    <div class="col-md-6">
                        <img src="assets/img/standard-ranges/MAC-Series5.jpg">
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        <h5>Oil/Air Cooler MAC</h5>
                        <img src="assets/img/standard-ranges/MAC-Series2.jpg" style="padding-bottom: 10px;">

                        <div class="download_catelog">
                            <a href="assets/pdf/mac-series.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!--<div class="col-md-12 ptb-30">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <img src="assets/img/standard-ranges/MAC-Series.PNG" alt="">
                        </div>
                        <div class="col-md-6">
                            <p>pressure drop at 30cSt</p>
                            <img src="assets/img/standard-ranges/MAC-Series1.PNG" alt="">
                        </div>
                    </div>
                </div>-->
