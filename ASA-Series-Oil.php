...
<head>
    <meta charset="utf-8">
    <title>ASA Series Oil | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">ASA Series Oil / Air Cooler</h1>
                    <h5>12V / 24V DC</h5>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row">
                    <div class="col-md-4">
                        <img src="assets/img/standard-ranges/asa-series5.jpg">

                    </div>
                    <div class="col-md-4">
                        <img src="assets/img/standard-ranges/asa-series4.jpg">
                    </div>
                    <div class="col-md-4">
                        <img src="assets/img/standard-ranges/asa-series3.jpg">
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        <h5>ASA Series Oil</h5>
                        <img src="assets/img/standard-ranges/asa-series4.jpg" style="padding-bottom: 10px;">

                        <div class="download_catelog">
                            <a href="assets/pdf/standard-asa-series1.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-12 mtop_25">
                <h1>ASA Series Oil / Air Cooler</h1>
                <h5>230/400 50Hz AC up to 500l/min</h5>
            </div>
            <div class="col-lg-9 col-md-12">
                <div class="col-md-10 offset-1">
                    <img src="assets/img/standard-ranges/asa-series13-3.jpg">
                </div>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        <h5>ASA Series Oil</h5>
                        <img src="assets/img/standard-ranges/asa-series13-3.jpg" style="padding-bottom: 10px;">

                        <div class="download_catelog">
                            <a href="assets/pdf/standard-asa-series2.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-12 mtop_25">
                <h1>ASA Series Oil / Air Cooler</h1>
                <h5>11cm³ hydraulic drive up to 500l/min</h5>
            </div>
            <div class="col-lg-9 col-md-12">
                <div class="col-md-10 offset-1">
                    <img src="assets/img/standard-ranges/asa-series15-3.jpg">
                </div>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        <h5>ASA Series Oil</h5>
                        <img src="assets/img/standard-ranges/asa-series15-3.jpg" style="padding-bottom: 10px;">

                        <div class="download_catelog">
                            <a href="assets/pdf/standard-asa-series3.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 mtop_25">
                <h1>ASA Universal connectors for ASA series oil cooler</h1>
                <h5>230/400 50Hz AC up to 500l/min</h5>
            </div>


            <div class="col-lg-9 col-md-12 ptop_0 ptb-30">
                <div class="col-md-12">
                    <h6>Description</h6>

                    <p>The asa universal connector is a patented system that offers many possibilities regarding
                        dimension and direction of the hydraulic connection.
                    </p>

                    <p>With each connector you can choose from 3 directions how to install it into the hydraulic
                        circuit. The stream optimized design reduces the total pressure drop on the cooler. The omission
                        of screwed joints reduces the number of sealing surfaces. The available connector dimensions
                        depend on the cooler size and are shown in the table below.</p>

                    <p>Our newest option is an intermediate plate for having an additional BSP ½” port, which can also
                        be turned in any required direction</p>

                    <div class="ptb-30">
                        <h6>Dimensions</h6>

                        <p>AUC NG 32 – 40 Connectors</p>
                        <img src="assets/img/standard-ranges/Assesories-16-2.gif" alt="">

                        <div class="">
                            <p>Intermediate plate NG 40</p>
                            <img src="assets/img/standard-ranges/Assesories-16.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        ...
                        <div>
                            <img src="assets/img/standard-ranges/Assesories-16-7.jpg" style="padding-bottom: 10px;">
                        </div>
                        <div class="download_catelog">
                            <a href="assets/pdf/asa-series-oil.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
                <img src="assets/img/standard-ranges/Assesories-16-3.jpg" alt="">
                <img src="assets/img/standard-ranges/Assesories-16-4.jpg" alt="">

                <img src="assets/img/standard-ranges/Assesories-16-5.jpg" alt="">

                <img src="assets/img/standard-ranges/Assesories-16-6.jpg" alt="">
            </div>
        </div>
    </div>
</section>
