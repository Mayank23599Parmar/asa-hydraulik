...
<head>
    <meta charset="utf-8">
    <title>Vibration Absorbe | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Vibration Absorber</h1>
                    <h5>MDGQ Absorber</h5>
                </div>
            </div>
           ...
           <div class="col-md-12">
                <div class="display-flex">
                    <div class="col-lg-9 col-md-12 ptb-30">
                        <p>The asa rubber vibration absorbers are rubber metal connected parts to absorb impact loads on
                            components as protection and to extent the life time. The patented solution is especially
                            equipped for highest shear loads. An assembly system controlled by arrows on the metal parts
                            helps to optimize and raise the load capability of the vibration absorber.</p>
                        <img src="assets/img/connection-techonology/MDGQ-all-sizes.jpg" alt="" class="full_width">
                    </div>
                    <div class="col-lg-3 col-md-5 margin_auto">
                        <div class="feature-imagebox border download-action">
                            <div class="block">
                                ...
                                <div>
                                    <img src="assets/img/connection-techonology/Vibration-Absorbe1.jpg" style="width: 60%;padding-bottom: 10px;">
                                </div>
