...
<head>
    <meta charset="utf-8">
    <title>Special Ranges | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Special Ranges</h1>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-12">
                <p>Our global business approach demands highest standards to our production facilities. We are equipped with newest production machines and processes. Furthermore we are continually upgrading the level of automation and quality. This ensures an appropriate support for research and development as well as for customized projects.</p>
                <p>We calculate, test and deliver complete thermal cooler packages to any application. Learn more about our engineering capabilities and see our technical solutions to the given topics in this section.</p><br>
                <img src="assets/img/special-ranges/special-ranges.jpg" alt="" class="full_width">
            </div>
            <div class="col-lg-3 col-md-5 margin_auto mtop_25">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        <h5>Special Ranges
                        </h5>
                        <p>Download our new catalogue or visit our hydraulics branch website.</p>
                        <!--<div>
                            <img src="assets/img/standard-ranges/Standard-ranges1.jpg" alt=""
                                 style="padding-bottom: 10px;">
                        </div>-->
                        <div class="download_catelog">
                            <a href="assets/pdf/special-ranges-compressed.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
