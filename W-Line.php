        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Anti-Corrosion oil/air coolers / W-Line</h1>
                    <!--<h5></h5>-->
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="display-flex">
                    <div class="col-lg-9 col-md-12">
                        <p>Our W series coolers are designed for high duration at aggressive environments as found in
                            offshore, marine and coastal applications. Nearly 40 years in manufacturing heat transfer
                            equipment has made us a global leader in advanced technologies. This ensures you competitive
                            pricing, consistent product performance and reliability.</p>

                        <p>The corrosion resistance of this series is successfully verified by salt spray tests
                            according DIN EN ISO 9227. This is comparable to C5-M short of ISO 12944. We allow a degree
                            of Ri3 according ISO 4312.</p><br>
                        <img src="assets/img/w-line/w-line.jpg" alt="" class="full_width">
                    </div>
                    <div class="col-lg-3 col-md-5 margin_auto">
                        <div class="feature-imagebox border download-action">
                            <div class="block">
                                ...
                                <p>The available types are equipped with our flexible asa universal connector system.
                                    Learn more about this system and download the information brochure or contact
                                    us.</p>

                                <div>
                                    <img src="assets/img/w-line/W-Line-1.jpg" alt="" style="padding-bottom: 10px;">
                                </div>
                                <div class="download_catelog">
                                    <a href="assets/pdf/W-Line.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
