...
<head>
    <meta charset="utf-8">
    <title>Compensators | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Compensators</h1>
                    <h5>SAE 1" to SAE 5"</h5>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-12">
                <p>Rubber compensators are elastic connectors with turnable SAE flanges. Compensators are used for
                    damping oscillations, vibrations, noises and movements in axial and transversal direction.</p>
                <h5>
                    Design
                </h5>

                <p>Rubber compensators have a plain surface vulcanized to a fabric body (inside and outside) of the
                    rubber part. The outside is weather resistant and protects the fabric against ageing, wear and
                    corrosion. The interior of the rubber part consists of nitril-butadien-caoutchouc (NBR). The
                    outer layer is made of CR (chloroprene rubber). Because compensators have tightening lips on
                    both sides, further seals are not necessary. </p>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        ...
                        <div>
                            <img src="assets/img/connection-techonology/Compensators4.jpg" style="padding-bottom: 10px; width: 60%">
                        </div>
            ...
            <div class="col-md-12 mtop_25">
                ...
                <p>
                    For all mineral oil products, crude oil, lubrication oil, cooling oil (-20°C up to 80°C),grease,
                    cold water, warm water up to 60°C, water/oil emulsions, fuel with 30% aromatic content. For
                    operation in suction and return lines.
                </p>
            </div>
...
<section class="section-about property-single nav-arrow-b">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="assets/img/connection-techonology/Compensators5.jpg" class="full_width">
            </div>
            <div class="col-md-6">
                <img src="assets/img/connection-techonology/Compensators6.JPG" class="full_width">
            </div>
</div></div></section>
<!--/ About End /-->
