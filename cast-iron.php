    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12">
                <p>
                    The asa butterfly flange with SAE and DIN connections allows the combination with an elastic
                    element (rubber compensator) to make a short compensating and economical connection with the
                    pump port. The lever position can be changed through our new mechanism. The handle direction
                    (clockwise or counter clockwise) can be changed by turning the switch bracket. Please note that
                    the butterfly flange may only be opened in mounted state and with greased or lubricated sealing.
                    The adapter flange may only be welded with demounted butterfly flange.
                </p>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        ...
                        <div>
                            <img src="assets/img/connection-techonology/Suction-Line-4.jpg" style="width: 60%; padding-bottom: 10px;">
                        </div>
            ...
            <div class="col-md-8">
                <img src="assets/img/connection-techonology/Suction-Line1.jpg" alt="">
            </div>
            <div class="col-md-4">
                <img src="assets/img/connection-techonology/Suction-Line-1.png" alt="">
            </div>
        </div>
    </div>
</section>
