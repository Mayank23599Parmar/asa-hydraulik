...
<head>
    <meta charset="utf-8">
    <title>Thermal System | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Thermal Systems for oil/air/electronic cooling</h1>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-12 ptb-30">
                ...
                <p>The product group thermal systems is divided into four chapters: standard ranges, special ranges, h-ranges and the new e-loop ranges.</p><br>
                <img src="assets/img/thermal-systems.jpg" alt="" class="full_width">
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        ...
                        <p>Our standard range is a full program with many options to supply to any application. Gain from our trend setting quality, cost efficiency and versatility. Download our catalogue or visit our branch website for hydraulics.</p>

                        <div>
                            <img src="assets/img/standard-ranges/LowLine6.jpg" alt="" style="padding-bottom: 10px;">
                        </div>
                ...
                <div class="feature-imagebox border download-action mt-3">
                    <div class="block">
                        ...
                        <p>The special ranges show wide spread product programs for certain mobile and industrial applications. Learn more about our solutions to the specific technical requirements or these markets.</p>

                        <div>
                            <img src="assets/img/special-ranges/1.jpg" alt="" style="padding-bottom: 10px;">
                        </div>
                ...
                <div class="feature-imagebox border download-action mt-3">
                    <div class="block">
                        ...
                        <p>Discover the customized standard! The H-cube is a modular system, which offers three tank sizes with four oil/air cooler sizes, various fan drive types and a suction or return line filter.</p>

                        <div>
                            <img src="assets/img/special-ranges/2.jpg" alt="" style="padding-bottom: 10px;">
                        </div>
