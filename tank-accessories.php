...
<head>
    <meta charset="utf-8">
    <title>Tank Accesssories | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Tank Accesssories</h1>
                    <h5>Overview
                    </h5>
            ...
            <div class="col-md-12">
                <p>High quality accessories for tank applications save labor time and increase the quality of the end
                    product. Simplified technical solutions and standardized sizes are mandatory for successful OEM
                    business</p>
            ...
            <div class="col-md-10 margin_auto">
                <div class="row">
                    <div class="col-md-4 margin_bottom_20 mb-3">
                        <div class="feature-imagebox height_100_hiddden border download-action">
                            <div class="block">
                                <h5>Splash Guard Breather</h5>
                                <img src="assets/img/filter/tank-assessories-3.png" style="padding-bottom: 10px;" class="margin_bottom_50 width_50">

                                <div class="download_catelog catalouge_position">
                                    <a href="assets/pdf/DD-HTFPBA-in-rev0.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 margin_bottom_20 mb-3">
                        <div class="feature-imagebox height_100_hiddden border download-action">
                            <div class="block">
                                <h5>Filler Breather</h5>
                                <img src="assets/img/filter/filter-breather.jpg" style="padding-bottom: 10px;" class="margin_bottom_50 width_50">

                                <div class="download_catelog catalouge_position">
                                    <a href="assets/pdf/DD-HTFBA-in-rev0.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 margin_bottom_20 mb-3">
                        <div class="feature-imagebox height_100_hiddden border download-action">
                            <div class="block">
                                <h5>Air Breather</h5>
                                <img src="assets/img/filter/air-breather.jpg" style="padding-bottom: 10px;" class="margin_bottom_50 width_50">

                                <div class="download_catelog catalouge_position">
                                    <a href="assets/pdf/DD-HTBH-in-rev0.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-10 margin_auto">
                <div class="row">
                    <div class="col-md-4 margin_bottom_20 mb-3">
                        <div class="feature-imagebox height_100_hiddden border download-action">
                            <div class="block">
                                <h5>Suction Strainer</h5>
                                <img src="assets/img/filter/filter-1-2.jpg" style="padding-bottom: 10px;" class="margin_bottom_50 width_50">

                                <div class="download_catelog catalouge_position">
                                    <a href="assets/pdf/DD-HFFSS-in-rev0.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 margin_bottom_20 mb-3">
                        <div class="feature-imagebox height_100_hiddden border download-action">
                            <div class="block">
                                <h5>Oil level Gauge</h5>
                                <img src="assets/img/filter/gauge.png" style="padding-bottom: 10px; width: 25%" class="margin_bottom_50">

                                <div class="download_catelog catalouge_position">
                                    <a href="assets/pdf/DD-HTFLP-in-rev0.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 margin_bottom_20 mb-3">
                        <div class="feature-imagebox height_100_hiddden border download-action">
                            <div class="block">
                                ...
                                <img src="assets/img/filter/tank-assessories1.jpg" style="padding-bottom: 10px;" class="margin_bottom_50 width_50">

                                <div class="download_catelog catalouge_position">
                                    <a href="assets/pdf/DD-HTFTLA-in-rev0.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
