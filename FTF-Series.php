...
<head>
    <meta charset="utf-8">
    <title>FTF Series | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Concrete mixer cooler- FTF series</h1>
                    <h5>12V/24V with integrated suction filter and tank</h5>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-12 ptb-30">
                <img src="assets/img/ftf-series/ftf-series2.jpg" alt="" class="full_width">
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        ...
                        <div>
                            <img src="assets/img/ftf-series/ftf-series7.jpg" alt="" style="padding-bottom: 10px;">
                        </div>
                        <div class="download_catelog">
                            <a href="assets/pdf/ftf.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="display-flex">
                        <div class="col-md-6">
                            ...
                            <img src="assets/img/ftf-series/ftf-series1.jpg" alt="" class="full_width">
                        </div>
                        <div class="col-md-6">
                            <p>pressure drop at 30cSt</p>
                            <img src="assets/img/ftf-series/ftf-series.jpg" alt="" class="full_width">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <!--<div class="row">
            <div class="col-lg-9 col-md-12">
                <div class="row">
                    <div class="col-lg-3 col-md-5 margin_auto">
                        <img src="assets/img/ftf-series/ftf-series3.jpg" alt="" class="full_width">
                    </div><div class="col-lg-3 col-md-5 margin_auto">
                        <img src="assets/img/ftf-series/ftf-series4.jpg" alt="" class="full_width">
                    </div><div class="col-lg-3 col-md-5 margin_auto">
                        <img src="assets/img/ftf-series/ftf-series5.jpg" alt="" class="full_width">
                    </div><div class="col-lg-3 col-md-5 margin_auto">
                        <img src="assets/img/ftf-series/ftf-series6.jpg" alt="" class="full_width">
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <h2>FTF SeriesOil</h2>
            <h5>Air Cooler ECO 11FT 12V</h5>
            <h6>24V with integrated suction filter and tank</h6>
          <div class="col-md-10 offset-1">
              <img src="assets/img/ftf-series/ftf-series712.png" alt="" class="full_width">
          </div>
            </div>
            <!--<div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        <img src="assets/img/ftf-series/ftf-series10.jpg" alt="" class="full_width">
                    </div>
                    <div class="col-md-6">
                        <img src="assets/img/ftf-series/ftf-series11.jpg" alt="" class="full_width">
                    </div>
                </div>
            </div>-->
        </div>
