        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Filter</h1>
                    <h5>Overview
                    </h5>
            ...
            <div class="col-md-12 ptop_0 pt-3">
            ...
            <div class="col-lg-3 col-md-5 margin_auto margin_bottom_20">
                <div class="feature-imagebox height_100_hiddden border download-action">
                    <div class="block">
                        <h5>Return Filter</h5>
                        <img src="assets/img/filter/return-filter.png" class="margin_bottom_50 width_50 pb_50">

                        <div class="download_catelog catalouge_position">
                            <a href="assets/pdf/DD-HFTF-in-rev0.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto margin_bottom_20">
                <div class="feature-imagebox height_100_hiddden border download-action">
                    <div class="block">
                        <h5>Spin On Filter</h5>
                        <img src="assets/img/filter/spin.jpg" class="margin_bottom_50 width_100 pb_50">

                        <div class="download_catelog catalouge_position">
                            <a href="assets/pdf/DD-HFFHFL-in-rev0.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto margin_bottom_20">
                <div class="feature-imagebox border height_100_hiddden download-action">
                    <div class="block">
                        <h5>Suction Filter</h5>
                        <img src="assets/img/filter/suction.png" class="margin_bottom_50 width_50 pb_50">

                        <div class="download_catelog catalouge_position">
                            <a href="assets/pdf/DD-HFEP000074I00-in-rev0.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action height_100_hiddden">
                    <div class="block">
                        <h5>High Pressure Filter</h5>
                        <img src="assets/img/filter/high-pre.png" class="margin_bottom_50 width_50 pb_50">

                        <div class="download_catelog air_breather_pos">
