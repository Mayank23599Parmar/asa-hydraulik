    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 pt-3">
                <p>The asa high pressure compensator series is carried out as high performance design with very
                    flexible capabilities and long duration. Its highshap e design focusses most compact flange to
                    flang e dimension and excellent noise reduction and vibration absorption as well as high
                    movement tolerances in all directions.</p>

                <p>The sealing part of the rubber is designed to seal
                    without any additional sealing material. The turnable metal flanges are designed with a flare to
                    support the pressure performance of the product. This is a major difference to other solutions
                    in the market with direct impact to the high duration of the compensator.</p>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        ...
                        <div>
                            <img src="assets/img/connection-techonology/Compensators2.jpg" style="width: 60%; padding-bottom: 20px;">
                        </div>
                        <div class="download_catelog">
                            <a href="assets/pdf/compenstor-hp-series.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="section-about property-single nav-arrow-b">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <p>Please read our manual before installation!</p>
                <div class="row">
                    <div class="col-md-6">
                        <img src="assets/img/connection-techonology/Compensators.jpg" class="full_width">
                    </div>
                    <div class="col-md-6">
                        <img src="assets/img/connection-techonology/Compensators1.PNG" class="full_width">
                    </div>
                </div>
            </div>
