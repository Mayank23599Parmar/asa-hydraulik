...
<head>
    <meta charset="utf-8">
    <title>Connection Technology | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Connection Technology</h1>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-12">
                <p>Have you ever seen a company searching for bad technical solutions?</p>
                <p>As a global technology group with its different technical categories we have a wide-spread demand of technical solutions and products in the markets. When we find out that we are using an average solution or not even finding an appropriate product, we start developing it on our own! The connection technology product group is therefore a collection of solved problems and completes a lack of technology at different markets and applications. Take a look at our systems and solutions and get in contact for any new possible project development!</p>
                <a href="assets/pdf/connection-technology.pdf" target="_blank">catalog completely download</a><br>
                <img src="assets/img/connection-techonology/silent-block.jpg" alt="" class="full_width">
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        <h5>Vibration Absorber
                        </h5>
                        <p>The asa rubber vibration absorbers are rubber metal connected parts to absorb impact loads and to extent the life time on components. The unique design handles three times higher shear loads than conventional absorbers!</p>


                        <div>
                            <img src="assets/img/connection-techonology/Vibration-Absorbe1.jpg" alt="" style="padding-bottom: 10px;" class="width_50">
                        </div>
                        <div class="download_catelog">
                            <a href="assets/pdf/vibration-absorber.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
                <div class="feature-imagebox border download-action mt-3">
                    <div class="block">
                        ...
                        <p>The asa high pressure compensator series is carried out as high performance design with very flexible capabilities and long duration. </p>

                        <div>
                            <img src="assets/img/connection-techonology/Compensators4.jpg" alt="" style="padding-bottom: 10px;" class="width_50">
                        </div>
                        <div class="download_catelog">
                            <a href="assets/pdf/compensator-sae1.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                ...
                <div class="feature-imagebox border download-action mt-3">
                    <div class="block">
                        ...
                        <p>The asa suction unit has been developed to provide a compact unit in hydraulic systems from tank to pump.</p>

                        <div>
                            <img src="assets/img/connection-techonology/Suction-Line-4.jpg" alt="" style="padding-bottom: 10px;" class="width_50">
                        </div>
                        <div class="download_catelog">
                            <a href="assets/pdf/suction-line.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
