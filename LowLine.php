        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">LowLine 03, 06 and 08 Oil / Air Cooler</h1>

                    <h5>12V / 24V DC, HP (high performance) up to 160l/min
                    </h5>
            ...
            <div class="col-md-12 ptop_0 pt-3"></div>
            <div class="col-lg-9 col-md-12">
                <!--<img src="assets/img/standard-ranges/LowLine.jpg" alt="">-->
                <div class="row">
                    <div class="col-md-4">
                        <img src="assets/img/standard-ranges/LowLine8.jpg" alt="" class="full_width">
                    </div>
                    <div class="col-md-4">
                        <img src="assets/img/standard-ranges/LowLine7.jpg" alt="" class="full_width">
                    </div>
                    <div class="col-md-4">
                        <img src="assets/img/standard-ranges/LowLine6.jpg" alt="" class="full_width">
                    </div>
                </div>
            </div>
            <div class="col-lg-3 margin_auto mtop_25 col-md-5">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        <h5>LowLine DC</h5>
                        <img src="assets/img/standard-ranges/LowLine8.jpg" style="width: 100%; padding-bottom: 10px;">

                        <div class="download_catelog">
                            <a href="assets/pdf/low-line.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 mtop_25">
                <h2>LowLine 03, 06 and 08 Oil / Air Cooler</h2>
                <h5>230V 50Hz AC up to 160l/min</h5>
            </div>
            <div class="col-lg-9 col-md-12">
                <div class="row">
                    <div class="col-md-4 pt-3">
                        <img src="assets/img/standard-ranges/LowLine10.jpg">
                    </div>
                    <div class="col-md-4">
                        <img src="assets/img/standard-ranges/LowLine11.jpg">
                    </div>
                    <div class="col-md-4">
                        <img src="assets/img/standard-ranges/LowLine9.jpg">
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-5 mtop_25 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        <h5>LowLine AC</h5>
                        <img src="assets/img/standard-ranges/LowLine8.jpg" style="width: 100%; padding-bottom: 10px;">
                        ...
                        <div class="download_catelog">
                            <a href="assets/pdf/low-line1.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <!-- <div class="col-md-12 ptb-30">
                 ...
                 <div class="row">
                     <div class="col-md-6">
                         <p>specific cooling performance</p>
                         <img src="assets/img/standard-ranges/LowLine2.PNG" alt="">
                     </div>
                     <div class="col-md-6">
                         <p>pressure drop at 30cSt</p>
                         <img src="assets/img/standard-ranges/LowLine1.jpg" alt="">
                     </div>
            ...
            <!--<div class="col-md-12">
                ...
                <div class="col-md-10 offset-md-1">
                    <img src="assets/img/standard-ranges/LowLine5.jpg" alt="" class="full_width">
                </div>
                <div class="col-md-12 ptb-30">
                    <h5>Performance</h5>
                    <div class="row">
                        <div class="col-md-5">
                            <p>specific cooling performance</p>
                            <img src="assets/img/standard-ranges/LowLine3.PNG" alt="">
                        </div>
                        <div class="col-md-4">
                            <p>pressure drop at 30cSt</p>
                            <img src="assets/img/standard-ranges/LowLine1.jpg" alt="">
                        ...
                        <div class="col-md-4">
                            <img src="assets/img/standard-ranges/LowLine9.jpg" alt="">
                        </div>
                        <div class="col-lg-3 col-md-5 margin_auto">
                            <div class="feature-imagebox border download-action">
                                <div class="block">
                                    ...
                                    <div class="download_catelog">
                                        <a href="assets/pdf/low-line1.pdf"
