        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box">
                    <h1 class="title-single">About asa</h1>
                    <h5>Who we are and what we offer</h5>
                </div>
            </div>
            ...
            <div class="col-md-8">
                ...
                <p>Over the years, asa continually developed into a globally active systems supplier. Despite this
                    evolution, we consciously maintained the medium sized structure of a family owned company. As a
                    result we are able to respond quickly and flexibly to our customer’s demands and promote our
                    innovations Our increasing product portfolio and quality targets developed asa as a brand to the
                    next level. Thus made us create a new logo and appearance to strengthen our key values and highlight
                    it in all our present and future markets. We are proud on looking back on almost 40 years of
