...
<section class="intro-single padding_bottom_section">
 ...
 <div class="col-lg-9 col-md-12">
     <div class="col-md-8 offset-2">
         <img src="assets/img/standard-ranges/accessories.png">
     </div>
 </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        ...
                        <div>
                            <img src="assets/img/standard-ranges/Assecories21-1.jpg" style="padding-bottom: 10px;">
                        </div>
                        <div class="download_catelog">
                            <a href="assets/pdf/standard-accesories-1.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
