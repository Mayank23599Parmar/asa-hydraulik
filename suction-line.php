...
<head>
    <meta charset="utf-8">
    <title>Suction Line | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Suction Line</h1>
                    <h5>Butterfly Valve SAE 1 1/2" to SAE 5"</h5>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-12">
                <p>The asa butterfly flange with SAE and DIN connections allows the combination with an elastic element (rubber compensator) to make a short compensating and economical connection with the pump port. The lever position can be changed through our new mechanism.
                </p>
                <p>The handle direction (clockwise or counter clockwise) can be changed by turning the switch bracket. Please note that the butterfly flange may only be opened in mounted state and with greased or lubricated sealing. The adapter flange may only be welded with demounted butterfly flange. Please contact us for further information at support@asahydraulik.com or www.asahydraulik.com</p>
            </div>
            <div class="col-lg-3 col-md-5 margin_auto">
                <div class="feature-imagebox border download-action">
                    <div class="block">
                        ...
                        <div>
                            <img src="assets/img/connection-techonology/Suction-Line7.jpg" style="width: 60%; padding-bottom: 10px;">
                        </div>
                        <div class="download_catelog">
                            <a href="assets/pdf/alumini.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <img src="assets/img/connection-techonology/Suction-Line-5.jpg" alt="">
            </div>
            <div class="col-md-4">
                <img src="assets/img/connection-techonology/Suction-Line-1.jpg" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-12">
                <div id="property-single-carousel" class="owl-carousel owl-arrow gallery-property">
                    ...
                    <div class="carousel-item-b">
                        <img src="assets/img/connection-techonology/Suction-Line2.jpg" alt="">
                    </div>
                    <div class="carousel-item-b">
                        <img src="assets/img/connection-techonology/Suction-Line3.jpg" alt="">
                    </div>
                    <div class="carousel-item-b">
                        <img src="assets/img/connection-techonology/Suction-Line-4.jpg" alt="">
                    </div>
                    <div class="carousel-item-b">
                        <img src="assets/img/connection-techonology/Suction-Line-5.jpg" alt="">
                    </div>
                    <div class="carousel-item-b">
                        <img src="assets/img/connection-techonology/Suction-Line-6.jpg" alt="">
                    </div>
