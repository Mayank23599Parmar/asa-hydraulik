...
<head>
    <meta charset="utf-8">
    <title> Standard Ranges | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Standard Ranges</h1>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-12">
                <p>Our standard oil/air cooler range is still setting the bench mark in the markets. We offer short lead times and the densest program of pressure resistant coolers with all relevant features. Our internal bypass options and pollution resistant air fins are well known in the market and work globally, in various conditions.</p>
                <p>The versatility of our patented connection solutions are the best choice for a heat exchangers, as well as to receive an add on value to the end product.</p><br>
                <img src="assets/img/standard-ranges/Standard-ranges.jpg" alt="" class="full_width">
            </div>
