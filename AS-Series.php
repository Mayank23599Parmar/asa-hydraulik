...
<head>
    <meta charset="utf-8">
    <title>AS Series | asa-group</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box padding_bottom_section">
                    <h1 class="title-single">Multipurpose
                        AC cooler box / AS-Series</h1>
                    <h5>AS300 AC</h5>
                </div>
            </div>
            ...
            <div class="col-md-8">
                <img src="assets/img/as-series/as-series1.jpg" alt="" class="full_width">
            </div>
            <div class="col-md-4">
                <img src="assets/img/as-series/as-series3-1.jpg" alt="" class="full_width">
                <img src="assets/img/as-series/as-series3.jpg" alt="" class="full_width"><br>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row">
                    <div class="col-lg-3 col-md-5 margin_auto">
                        <img src="assets/img/as-series/as-series.jpg" alt="" class="full_width">
                    </div>
                    <div class="col-lg-3 col-md-5 margin_auto">

                    </div>
                    <div class="col-lg-3 col-md-5 margin_auto">
                        <img src="assets/img/as-series/as-series2.jpg" alt="" class="full_width">
                    </div>
                    <div class="col-lg-3 col-md-5 margin_auto">
    ...
    <div class="container">
                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <img src="assets/img/as-series/as-series.jpg" alt="">
                            </div>
                            <div class="col-md-6">
                                <p>pressure drop at 30cSt</p>
                                <img src="assets/img/as-series/as-series2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-5 margin_auto">
                        <div class="feature-imagebox border download-action">
                            <div class="block">
                                ...
                                <div>
                                    <img src="assets/img/as-series/as-series4.jpg" alt="" style="padding-bottom: 10px;">
                                </div>
                                <div class="download_catelog">
                                    <a href="assets/pdf/as-series.pdf" target="_blank">Download Catalogue <i class="fa fa-file-pdf-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-8">
                        <img src="assets/img/as-series/as-series5.jpg" alt="" class="full_width">
                    </div>
                    <div class="col-md-4">
                        <img src="assets/img/as-series/as-series8-1.jpg" alt="" class="full_width">
                        <img src="assets/img/as-series/as-series8-2.jpg" alt="" class="full_width">
                    </div>
                </div>
            </div>
            <div class="col-md-12 ptb-30">
                <div class="col-md-12">
                   <div class="col-md-12">
                       ...
                       <div class="display-flex">
                           <div class="col-md-6">
                               <p>specific cooling performance</p>
                               <img src="assets/img/as-series/as-series6.jpg" alt="">
                           </div>
                           <div class="col-md-6">
                               <p>pressure drop at 30cSt</p>
                               <img src="assets/img/as-series/as-series2.jpg" alt="">
